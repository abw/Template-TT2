...
#
# Modified by Andy Wardley to output states as list refs instead of hash
# refs.  It results in a parser speedup of about 10%.
#
...
warn "Using custom Parse::Yapp::Lalr for Template::TT2\n";

/*=====================================================================
*
* Template::TT2::Stash::XS (Stash.xs)
*
* DESCRIPTION
...
#define TT_STASH_PKG    "Template::TT2::Stash::XS"
#define TT_LIST_OPS     "Template::TT2::Stash::LIST_OPS"
#define TT_HASH_OPS     "Template::TT2::Stash::HASH_OPS"
#define TT_SCALAR_OPS   "Template::TT2::Stash::SCALAR_OPS"
#define TT_PRIVATE      "Template::TT2::Stash::PRIVATE"
...
MODULE = Template::TT2::Stash::XS   PACKAGE = Template::TT2::Stash::XS
...
dot(self, root, item, ...)
    ...
    args = (items > 3 && SvROK(ST(3)) && SvTYPE(SvRV(ST(3))) == SVt_PVAV) 
        ? (AV *) SvRV(ST(3)) 
        : Nullav;

    /* check default flag passed as fourth argument */
    lvalue = ((items > 4) && SvTRUE(ST(4))) 
        ? TT_LVALUE_FLAG 
        : 0;

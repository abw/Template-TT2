...
package Template::TT2::Directive;
...
#        $args = "$type, $info, body => \\\$output";
    ...
    return "\$context->flow_throw($args, \\\$output);";
...
Template::TT2::Directive - Perl code generator for template directives
...
The C<Template::TT2::Directive> module defines a number of methods that
generate Perl code for the runtime representation of the various 
Template Toolkit directives.

It is used internally by the L<Template::TT2::Parser> module.  It was
renamed and refactored from L<Template::Parser> as part of the move from
the C<Template::*> namespace to C<Template::TT2::*>.

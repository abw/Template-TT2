...
Template::TT2::VMethods - Virtual methods for variables

=head1 DESCRIPTION

The C<Template::TT2::VMethods> module implements the virtual methods
...
L<Template::TT2::Stash>, L<Template::Manual::VMethods>

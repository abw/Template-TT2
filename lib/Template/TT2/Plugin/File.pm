package Template::TT2::Plugin::File;

use Template::TT2::Class
    version    => 0.01,
    debug      => 0,
    base       => 'Template::TT2::Plugin',
    throws     => 'File',                       # TODO: lower for TT3
    constants  => 'HASH LAST';
...
sub new {
    ...
    return $class->error_msg( missing => 'file' )
    ...
    $class->debug("home: $home") if DEBUG;
...
Template::TT2::Plugin::File - Plugin providing information about files
...
minor tweaks.  He refactored it again for L<Template::TT2> in December 2008.

=head1 COPYRIGHT

Copyright 2000-2008 Andy Wardley, Michael Stevens
...
L<Template::TT2::Plugin>, L<Template::TT2::Plugin::Directory>, L<Template::TT2::View>
